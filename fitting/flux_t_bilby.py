# -*- coding: utf-8 -*-
"""
flux_t_double_fred_bilby.py - 修复版本 v2
...
N_LIVE = 500  # 采样点数（降低可加快调试，生产用2000以上）
...
for rig in SELECTED_RIGS:
    ...
    # 第一个脉冲：较早出现
    Delta1_init = time_min 
    # 第二个脉冲：较晚出现，错开一定时间
    Delta2_init = time_min + 10
