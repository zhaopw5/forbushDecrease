...
OUT_CSV = "flux_long_check_2015.csv"              # output CSV path

START_DATETIME = "2011-01-01 00:00:00" # first timestamp of your hourly data

# Optional time window; set to None to disable
TIME_MIN = pd.Timestamp("2015-05-01 00:00:00")  # e.g., "2015-03-10 00:00:00" or None
TIME_MAX = pd.Timestamp("2015-08-01 23:00:00")  # e.g., "2015-03-24 23:00:00" or None
