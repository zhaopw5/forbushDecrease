...
AMS_FILE = f"/home/zpw/Files/forbushDecrease/FDs/{EVENT_DIR}/ams_processed.csv"
OMNI_FILE = f"/home/zpw/Files/forbushDecrease/FDs/{EVENT_DIR}/omni_processed.csv"
...
plt.tight_layout()
plt.savefig(f"/home/zpw/Files/forbushDecrease/FDs/{EVENT_DIR}/correlation_heatmap_pearson.png", dpi=300)#, bbox_inches='tight')
plt.close(fig)
print(f"\n[✓] 热图已保存: /home/zpw/Files/forbushDecrease/FDs/{EVENT_DIR}/correlation_heatmap_pearson.png")
...
plt.tight_layout()
plt.savefig(f"/home/zpw/Files/forbushDecrease/FDs/{EVENT_DIR}/correlation_heatmap_spearman.png", dpi=300)#, bbox_inches='tight')
plt.close(fig)
print(f"\n[✓] 热图已保存: /home/zpw/Files/forbushDecrease/FDs/{EVENT_DIR}/correlation_heatmap_spearman.png")
...
plt.tight_layout()
plt.savefig(f"/home/zpw/Files/forbushDecrease/FDs/{EVENT_DIR}/lag_correlation.png", dpi=300, bbox_inches='tight')
plt.close(fig)
print(f"[✓] 滞后分析图已保存: /home/zpw/Files/forbushDecrease/FDs/{EVENT_DIR}/lag_correlation.png")

# ---------- 4. 保存结果 ----------
# 保存相关系数表
corr_matrix.to_csv(f"/home/zpw/Files/forbushDecrease/FDs/{EVENT_DIR}/correlation_matrix_pearson.csv")
spearman_matrix.to_csv(f"/home/zpw/Files/forbushDecrease/FDs/{EVENT_DIR}/correlation_matrix_spearman.csv")
pval_matrix.to_csv(f"/home/zpw/Files/forbushDecrease/FDs/{EVENT_DIR}/pvalue_matrix.csv")
