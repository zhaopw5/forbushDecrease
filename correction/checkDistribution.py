...
plt.tight_layout()
plt.savefig(f"/home/zpw/Files/forbushDecrease/FDs/{EVENT_DIR}/distribution_check.png", dpi=300, bbox_inches='tight')
plt.close(fig)
print(f"[✓] 分布检验图已保存: /home/zpw/Files/forbushDecrease/FDs/{EVENT_DIR}/distribution_check.png")
...
if target_ams in df.columns:
    ...
    plt.tight_layout()
    plt.savefig(f"/home/zpw/Files/forbushDecrease/FDs/{EVENT_DIR}/scatter_linearity_check.png", dpi=300, bbox_inches='tight')
    plt.close(fig)
    print(f"[✓] 散点图已保存: /home/zpw/Files/forbushDecrease/FDs/{EVENT_DIR}/scatter_linearity_check.png")

# ---------- 6. 保存检验报告 ----------
report_df = pd.DataFrame(distribution_report)
report_df.to_csv(f"/home/zpw/Files/forbushDecrease/FDs/{EVENT_DIR}/distribution_report.csv", index=False)
print(f"[✓] 检验报告已保存: /home/zpw/Files/forbushDecrease/FDs/{EVENT_DIR}/distribution_report.csv")
